#修改
[Script]
http-response ^https:\/\/ap(p|i)\.bili(bili|api)\.(com|net)\/x\/resource\/ script-path=https://raw.githubusercontent.com/NobyDa/Script/master/Surge/JS/Bili_Auto_Regions.js, requires-body=true, tag=bili自动地区
